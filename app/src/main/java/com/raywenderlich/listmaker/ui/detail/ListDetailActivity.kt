...
import com.raywenderlich.listmaker.ui.detail.ui.listdetail.ListDetailViewModel
...
lateinit var viewModel : MainViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this, MainViewModelFactory(PreferenceManager.getDefaultSharedPreferences(this))).get(
